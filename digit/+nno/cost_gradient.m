...
function [g] = cost_gradient(model, P, dt, q0, u0, u, Cq, qd, h)
    %% Setup
    N = length(u);
    g = zeros(size(u));
    ...
    for i = 1:N
        ...
        Cn1 = nno.cost(model, P, dt, q0, u0, un1, Cq, qd);
        Cp1 = nno.cost(model, P, dt, q0, u0, up1, Cq, qd);
...
%         up2(i) = u(i) + 2*h;
% 
%         Cn2 = nno.cost(model, P, dt, q0, u0, un2, c, m, L, Cq, thd, 'Gradient u(i-2)');
%         Cp2 = nno.cost(model, P, dt, q0, u0, up2, c, m, L, Cq, thd, 'Gradient u(i+2)');
% 
