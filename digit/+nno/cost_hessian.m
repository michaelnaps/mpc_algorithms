...
function [H] = cost_hessian(P, dt, q0, u0, u, Cq, qd, h, model)
    %% Setup
    N = length(u);
    H = zeros(N);
    ...
    for i = 1:N
        ...
        Hn1 = nno.cost_gradient(P, dt, q0, u0, un1, Cq, qd, h, model);
        Hp1 = nno.cost_gradient(P, dt, q0, u0, up1, Cq, qd, h, model);
