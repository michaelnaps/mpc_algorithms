...
function [g] = cost_gradient(P, dt, q0, u0, u, c, m, L, Cq, thd, h, loc)
    %% Setup
    N = length(u);
    g = zeros(size(u));
    ...
    for i = 1:N
        ...
        Cn1 = nno.cost(P, dt, q0, u0, un1, c, m, L, Cq, thd, " Gradient u(i-1) " + loc);
        Cp1 = nno.cost(P, dt, q0, u0, up1, c, m, L, Cq, thd, " Gradient u(i+1) " + loc);
