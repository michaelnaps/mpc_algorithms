function [T, q] = mpc_root(P, T, q0, um, c, m, L, Cq, qd, alph, eps, h, height, push)
    %% Setup
    dt = T(2) - T(1);
    ...
    for i = 2:length(T)
        ...
        qd = pend_height(T(i), L, qd, height);
        
        % Calculate Optimal Input and Next State
        tic
        [u, C, n, brk, a] = ngd.gdescent(P, dt, q(i-1,1:6)', q(i-1,7:9)', um, c, m, L, Cq, qd, alph, eps, h);
        t = toc;
