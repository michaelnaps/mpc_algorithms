...
function [g] = cost_gradient(P, dt, q0, u0, u, c, m, L, Cq, qd, h, loc)
    %% Setup
    N = length(u);
    g = zeros(size(u));
    ...
    for i = 1:N
        ...
        Cn1 = ngd.cost(P, dt, q0, u0, un1, c, m, L, Cq, qd, " Gradient u(i-1) " + loc);
        Cp1 = ngd.cost(P, dt, q0, u0, up1, c, m, L, Cq, qd, " Gradient u(i+1) " + loc);
